...
namespace SharpQuake
{
    static class Net
    {
        ...
        static readonly PollProcedure _SlistSendProcedure = new PollProcedure(null, 0.0, SlistSend, null);
        static readonly PollProcedure _SlistPollProcedure = new PollProcedure(null, 0.0, SlistPoll, null);

        static INetDriver[] _Drivers; // net_driver_t net_drivers[MAX_NET_DRIVERS];
        static INetLanDriver[] _LanDrivers; // net_landriver_t	net_landrivers[MAX_NET_DRIVERS]
        static bool _IsRecording; // recording
        ...
        static int _UnreliableMessagesSent = 0;
        static int _UnreliableMessagesReceived = 0;

        static Cvar _MessageTimeout;// = { "net_messagetimeout", "300" };
        static Cvar _HostName;// = { "hostname", "UNNAMED" };
        ...
        public static bool SlistSilent; // slistSilent
        public static bool SlistLocal = true; // slistLocal
        static int _SlistLastShown; // slistLastShown
        static double _SlistStartTime; // slistStartTime

        static int _DriverLevel; // net_driverlevel
        public static int LanDriverLevel; // net_landriverlevel

        static VcrRecord _VcrConnect = new VcrRecord(); // vcrConnect
        static VcrRecord2 _VcrGetMessage = new VcrRecord2(); // vcrGetMessage
        static VcrRecord2 _VcrSendMessage = new VcrRecord2(); // vcrSendMessage
        ...
        {
            get { return _UnreliableMessagesSent; }
        }
        public static int UnreliableMessagesReceived
        {
            get { return _UnreliableMessagesReceived; }
        }
        ...
        {
            get { return _MyTcpIpAddress; }
            set { _MyTcpIpAddress = value; }
        }
        public static int DefaultHostPort
        {
            get { return _DefHostPort; }
        }
        ...
        {
            get { return _DriverLevel; }
        }
        public static INetLanDriver LanDriver
        {
            get { return _LanDrivers[LanDriverLevel]; }
        }
        public static INetDriver Driver
        {
            get { return _Drivers[_DriverLevel]; }
        }

        public static bool SlistInProgress
        {
            get { return _SlistInProgress; }
        }
    ...
    delegate void PollHandler(object arg);
