...
namespace SharpQuake
{
    ...
    static class Sbar
    {
        ...
        static int _Updates; // sb_updates		// if >= vid.numpages, no update needed
        static bool _ShowScores; // sb_showscores

        const int STAT_MINUS = 10;	// num frame for '-' stats digit
        
        static glpic_t[,] _Nums = new glpic_t[2,11];
        ...
        static glpic_t[,] _Weapons = new glpic_t[7,8];   // 0 is active, 1 is owned, 2-5 are flashes
        static glpic_t[] _Ammo = new glpic_t[4];
        static glpic_t[] _Sigil = new glpic_t[4];
        static glpic_t[] _Armor = new glpic_t[3];
        static glpic_t[] _Items = new glpic_t[32];

        static glpic_t[,] _Faces = new glpic_t[7,2];		// 0 is gibbed, 1 is dead, 2-6 are alive
							        // 0 is static, 1 is temporary animation
        static glpic_t _FaceInvis;
        static glpic_t _FaceQuad;
        static glpic_t _FaceInvuln;
        static glpic_t _FaceInvisInvuln;

        static glpic_t[] _RInvBar = new glpic_t[2];
        static glpic_t[] _RWeapons = new glpic_t[5];
        static glpic_t[] _RItems = new glpic_t[2];
        static glpic_t[] _RAmmo = new glpic_t[3];
        static glpic_t _RTeamBord;		// PGM 01/19/97 - team color border

        //MED 01/04/97 added two more weapons + 3 alternates for grenade launcher
        static glpic_t[,] _HWeapons = new glpic_t[7,5];   // 0 is active, 1 is owned, 2-5 are flashes
        ...
        static glpic_t[] _HItems = new glpic_t[2];
        ...
        /// </summary>
        static void IntermissionNumber(int x, int y, int num, int digits, int color)
        {
        ...
        // Sbar_DrawNum
        static void DrawNum(int x, int y, int num, int digits, int color)
        {
        ...
        // Sbar_ColorForMap
        static int ColorForMap(int m)
        {
            return m < 128 ? m + 8 : m + 8;
        }

        // Sbar_SoloScoreboard
        static void SoloScoreboard()
        {
