...
namespace SharpQuake
{
    ...
    static class Cmd
    {
        ...
        static cmd_source_t _Source; // extern	cmd_source_t	cmd_source;
        static Dictionary<string, string> _Aliases;
        static Dictionary<string, xcommand_t> _Functions;
        static int _Argc;
        static string[] _Argv;// char	*cmd_argv[MAX_ARGS];
        static string _Args;// char* cmd_args = NULL;
        static bool _Wait; // qboolean cmd_wait;
