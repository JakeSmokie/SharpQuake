...
namespace SharpQuake
{
    static partial class Server
    {
        ...
        static Cvar _Friction;// = { "sv_friction", "4", false, true };
        static Cvar _EdgeFriction;// = { "edgefriction", "2" };
        static Cvar _StopSpeed;// = { "sv_stopspeed", "100" };
        static Cvar _Gravity;// = { "sv_gravity", "800", false, true };
        static Cvar _MaxVelocity;// = { "sv_maxvelocity", "2000" };
        static Cvar _NoStep;// = { "sv_nostep", "0" };
        static Cvar _MaxSpeed;// = { "sv_maxspeed", "320", false, true };
        static Cvar _Accelerate;// = { "sv_accelerate", "10" };
        static Cvar _Aim;// = { "sv_aim", "0.93" };
        static Cvar _IdealPitchScale;// = { "sv_idealpitchscale", "0.8" };

        static server_t _Server;
        static server_static_t _ServerStatic;

        static string[] _LocalModels = new string[QDef.MAX_MODELS]; //[MAX_MODELS][5];	// inline model names for precache
        ...
        {
            get { return _Server.state == server_state_t.Loading; }
        }
        public static float Aim
        {
            get { return _Aim.Value; }
        }
