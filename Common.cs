...
namespace SharpQuake
{
    ...
    class LittleEndianConverter : IByteOrderConverter
    {
    ...
    class BigEndianConverter : IByteOrderConverter
    {
        #region IByteOrderConverter Members
    ...
    class DisposableWrapper<T> : IDisposable where T : class, IDisposable
    {
        T _Object;
        bool _Owned;
    ...
    class QuakeException : Exception
    {
    ...
    class EndGameException : QuakeException
    {
    }

    class QuakeSystemError : QuakeException
    {
