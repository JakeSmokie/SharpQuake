...
namespace SharpQuake
{
    ...
    static partial class Sound
    {
        ...
        static Cvar _BgmVolume = new Cvar("bgmvolume", "1", true);// = { "bgmvolume", "1", true };
        static Cvar _Volume = new Cvar("volume", "0.7", true);// = { "volume", "0.7", true };
        static Cvar _NoSound = new Cvar("nosound", "0");// = { "nosound", "0" };
        static Cvar _Precache = new Cvar("precache", "1");// = { "precache", "1" };
        static Cvar _LoadAs8bit = new Cvar("loadas8bit", "0");// = { "loadas8bit", "0" };
        static Cvar _BgmBuffer = new Cvar("bgmbuffer", "4096");// = { "bgmbuffer", "4096" };
        static Cvar _AmbientLevel = new Cvar("ambient_level", "0.3");// = { "ambient_level", "0.3" };
        static Cvar _AmbientFade = new Cvar("ambient_fade", "100");// = { "ambient_fade", "100" };
        static Cvar _NoExtraUpdate = new Cvar("snd_noextraupdate", "0");// = { "snd_noextraupdate", "0" };
        static Cvar _Show = new Cvar("snd_show", "0");// = { "snd_show", "0" };
        static Cvar _MixAhead = new Cvar("_snd_mixahead", "0.1", true);// = { "_snd_mixahead", "0.1", true };
        ...
        static channel_t[] _Channels = new channel_t[MAX_CHANNELS]; // channels[MAX_CHANNELS]
        static int _TotalChannels; // total_channels

        static float _SoundNominalClipDist = 1000.0f; // sound_nominal_clip_dist
        static Vector3 _ListenerOrigin; // listener_origin
        static Vector3 _ListenerForward; // listener_forward
        static Vector3 _ListenerRight; // listener_right
        static Vector3 _ListenerUp; // listener_up

        static int _SoundTime; // soundtime		// sample PAIRS
        static int _PaintedTime; // paintedtime 	// sample PAIRS
        static bool _SoundStarted; // sound_started
        static int _SoundBlocked = 0; // snd_blocked
        static int _OldSamplePos; // oldsamplepos from GetSoundTime()
        static int _Buffers; // buffers from GetSoundTime()
        static int _PlayHash = 345; // hash from S_Play()
        static int _PlayVolHash = 543; // hash S_PlayVol
