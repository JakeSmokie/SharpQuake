...
namespace SharpQuake
{
    class NetTcpIp : INetLanDriver
    {
        ...
        bool _IsInitialized;
        IPAddress _MyAddress; // unsigned long myAddr
        Socket _ControlSocket; // int net_controlsocket;
        Socket _BroadcastSocket; // net_broadcastsocket
        EndPoint _BroadcastAddress; // qsockaddr broadcastaddr
        Socket _AcceptSocket; // net_acceptsocket
